...
<package xmlns="http://schemas.microsoft.com/packaging/2010/07/nuspec.xsd">
  <metadata>
    <id>$PKGID</id>
    <title>TFS Express 2013 build type installation</title>
    <version>$VERSION_NUMBER.$BUILD_NUMBER</version>
    <authors>$ORGANIZATION_NAME</authors>
    <owners>$ORGANIZATION_NAME</owners>
    <summary>TFS Express 2013 build type installation</summary>
    <description>Installs TFS Express using the build type, and validates that IIS and SQL server are installed.</description>
